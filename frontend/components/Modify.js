    ...
    <div className='bg-gray-800 w-6/12 h-4/5 flex flex-col items-center mr-10 py-4 px-8 rounded-md shadow-xl text-center'>
      <form className='flex flex-col justify-around h-full w-full' onSubmit={e => onSubmitForm(e)}>
        ...
        <label htmlFor='notes'>
          ...
          <textarea className=' text-white text-xl mb-2 px-4 py-1 w-full h-96 focus:outline-none bg-gray-700 rounded-md' type='date' id='notes' name='notes'>
            {app.notes}
          </textarea>
        </label>
        <button type='submit' className='bg-green-400 text-white mx-auto font-bold text-xl w-32 px-1 py-4 rounded-md hover:bg-green-500 focus:outline-none'>Submit</button>
      </form>
    </div>
  )
}
